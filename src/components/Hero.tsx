          ...
          <div className="mx-auto max-w-2xl py-16">
            <div className="">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600">
                ...
                teknologi-teknologi terbaru. Work and grow together, celebrate each others improvements. Find a job through team spirit. Work in teams, improve your skills, and create an
